...
class MultiLayout extends React.Component {
  ...
  */
  ...
  render() {
    ...
    const [leftSidebar, renderGraph, newComponent, rightSidebar] = children;
    return (
        <div
            style={{
                display: "grid",
            ...
            [graph-end separator-start] 1px
            [separator-end new-component-start] 1fr
            [new-component-end right-sidebar-start] ${
                    globals.rightSidebarWidth + 1
                }px [right-sidebar-end]
          `,
                gridTemplateRows: "[top] auto [bottom]",
                gridTemplateAreas: `
            "left-sidebar graph separator new-component right-sidebar"
          `,
                columnGap: "0px",
        ...
        >
            ...
            <div
                style={{
                    gridArea: "top / separator-start / bottom / separator-end",
                    position: "relative",
                    height: "inherit",
            ...
            <div
                style={{
                    zIndex: 0,
                    gridArea: "top / new-component-start / bottom / new-component-end",
                    position: "relative",
                    height: "inherit",
                }}
                ref={(ref) => {
            ...
            >
                {this.viewportRef ? newComponent(this.viewportRef) : null}
            </div>
            <div
                style={{
